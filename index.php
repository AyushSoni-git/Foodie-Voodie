...
<header class="header">
    <div class="row">
        <div class="col-md-12 text-center">
            <a class="logo"><img src="img/Foodie-Voodie.png" alt="logo"></a>
        </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
    ...
    <div class="container">
        <h3 class="text-center"><br><br>Foodie-Voodie</h3>
        <div class="row">
            <!--carousel-->
            ...
            <div class="col-sm">
                <div class="arranging"><br>
                    ...
                    <p><br>Foodie-Voodie is a preneur started by us for providing the facility of making restaurant reservations by being at
                        home so as to avoid having to go to the restaurant and getting disappointed if you don't get tables ready on time.<br><br><br></p>
                    <hr>
                </div>
            </div>
        </div><br>
...
<section class="map" id="footer">
    <div class="container">
        ...
        <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAIABwmWkjagbrC1z0uRvH60wT-VQoDGlo
    &q=DIT+University,Dehradun+Uttrakhand" style=" width:100%; height:250px; border:0;" allowfullscreen></iframe>
        ...
        <div class="row staff">
            ...
            <div class="col">
                ...
                <p class="text-right">Foodie-Voodie<br><i class="fa fa-map-marker"></i>&nbsp; Dehradun, <br>Uttarakhand <br><br>email: infofoodie@gmail.com<br>phone: +91 (123) 456 7890</p>
            </div>
